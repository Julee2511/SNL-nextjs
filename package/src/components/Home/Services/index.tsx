...
const Services = () => {
    ...
    <div className="container px-3 lg:max-w-screen-xl md:max-w-screen-md grid grid-cols-12 gap-4 py-20 ">
        ...
        <div className="md:col-span-6 col-span-12 mt-7">
            <div className="flex items-start">
                <span className="text-blue-500 text-4xl font-bold mr-4 mb-8">1</span>
                <p className="text-gray-800 text-lg mb-20 mt-1">Full service range including</p>
            </div>
            <div className="flex items-start">
                <span className="text-blue-500 text-4xl font-bold mr-4 mb-8">2</span>
                <p className="text-gray-800 text-lg mb-20 mt-1">Technical skills, design, business</p>
            </div>
            <div className="flex items-start mb-7">
                <span className="text-blue-500 text-4xl font-bold mr-4">3</span>
