        ...
        <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md">
          <div className="">
            <div className="grid md:grid-cols-6 lg:grid-cols-9 grid-cols-1 gap-7 border-b border-solid border-white border-opacity-50 pb-11">
              ...
              <div className="col-span-3">
                <Link href="mailto:headoffice@property.com" className="sm:text-24 text-xl text-white font-medium underline">headoffice@property.com</Link>
            ...
            <div className="grid md:grid-cols-6 lg:grid-cols-9 grid-cols-1 gap-7 pt-12">
              ...
              <div className="col-span-3">
                <Link href="mailto:Office@property.com" className="sm:text-24 text-xl text-white font-medium underline">Office@property.com</Link>
